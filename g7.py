''' g7 == g6  with smaller penalties for errors in grammar weighted loss '''
...
def grammar_weighted_loss(label_ids, logits, var_err = 0.1, func_err = 0.2, category_err = 0.4):
