...
def preprocess(e):
    ...
    return {"input_ids": decoder_input["input_ids"], "attention_mask": decoder_input["attention_mask"],
...
def custom_data_collator(examples):
    ...
    batch = {**decoder_batch, "encoder_input_ids": encoder_batch["input_ids"], "encoder_attention_mask": encoder_batch["attention_mask"]}
