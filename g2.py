...
def parse(line: str): 
  ...
  target = s_expr_to_str(ast, lpar="[LPAR]", rpar="[RPAR]").replace("[RPAR] [LPAR]", "[RPAR][LPAR]")
...
tokenizer.add_special_tokens({'additional_special_tokens':["[LPAR]", "[RPAR]"]})
def preprocess(e):
    alt_bodies = []
